...
<template>
  <div class="p-0 bg-transparent space-y-4">
    <!-- شريط البحث السريع بنمط الكاشير (باركود / كود / اسم الصنف) -->
    <div
    ...
    >
      <SmartSearchGrid
        ...
        :columns="[
          ...
          { key: 'cost_display', label: 'سعر التكلفة الافتراضي', class: 'text-center' },
          { key: 'stock_display', label: 'الرصيد الكلي المتاح', class: 'text-center' },
        ]"
        :search-keys="['id', 'name', 'code', 'all_barcodes']"
        placeholder="ابحث بالاسم، كود الصنف، أو امسح الباركود لإدراج بند أمر الشراء فوراً..."

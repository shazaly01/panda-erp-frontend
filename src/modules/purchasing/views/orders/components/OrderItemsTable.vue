<!-- src/modules/purchasing/views/orders/components/OrderItemsTable.vue -->
<template>
  <div class="p-0 bg-transparent space-y-3 font-sans text-right" dir="rtl">
    ...
    <!-- جدول إدخال وتعديل بنود أمر الشراء المباشر -->
      ...
      <table class="w-full text-right border-collapse text-xs">
        <thead>
          <tr class="bg-[#121316] text-gray-300 border-b border-[#3e414c] font-bold select-none">
            ...
            <th class="py-3 px-2 text-center min-w-[125px] w-32">الكمية</th>
            <th class="py-3 px-2 text-center min-w-[110px] w-28">سعر الوحدة</th>
            <th class="py-3 px-2 text-center min-w-[85px] w-20">خصم %</th>
            <th class="py-3 px-2 text-center min-w-[85px] w-20">ضريبة %</th>
            <th class="py-3 px-2 text-center min-w-[105px] w-28">قبل الضريبة</th>
        ...
        <tbody class="divide-y divide-[#2a2e39]">
            ...
            <td class="py-2.5 px-2 text-center align-middle">
              <div class="inline-flex items-center justify-center">
                <span
                  ...
                  title="الكمية المتوفرة حالياً في المستودعات"
                >
          ...
          <tr v-if="items.length === 0">
            <td colspan="11" class="p-8 text-center text-gray-400 text-xs font-medium">
              لم تسجل أي بند بأمر الشراء حتى الآن. انقر على الزر أدناه لإضافة البند الأول.
            </td>
          </tr>
        </tbody>
      </table>
    ...
    <div class="flex items-center justify-between pt-1">
      ...
      >
        ...
        <span>+ إضافة بند أمر شراء آخر (Ctrl + Enter)</span>
      </button>
...
const columnsOrder = ['name', 'unit', 'qty', 'price', 'discount', 'tax']
...
const navigateHorizontal = (rowIndex, currentColKey, direction) => {
  ...
  if (targetIdx >= 0 && targetIdx < columnsOrder.length) {
    ...
    focusCell(rowIndex - 1, 'tax', false)
  }
}

<!-- src/modules/purchasing/views/requisitions/components/RequisitionsFilter.vue -->
<template>
  <div
    class="p-4 bg-[#212634] rounded-2xl border border-[#323a4e] shadow-md text-right space-y-3 font-sans"
    dir="rtl"
  >
    <!-- شبكة الفلاتر بتناسق السمة الداكنة -->
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 items-center">
      ...
      <div class="relative flex items-center">
        <input
          type="text"
          v-model="search"
          placeholder="بحث برقم الطلب، الملاحظات..."
      ...
      <div class="relative flex items-center">
        ...
        >
          <option value="">كافة حالات الطلبات</option>
          <option value="draft">مسودة قيد الإعداد</option>
          <option value="pending">بانتظار الاعتماد</option>
          <option value="approved">طلب معتمد</option>
          <option value="rejected">طلب مرفوض</option>
        </select>
      ...
      <div class="relative flex items-center">
        <select
          ...
          class="w-full h-[42px] px-3.5 bg-[#181d28] text-white text-xs font-bold rounded-xl border border-[#374158] hover:border-gray-400 focus:border-[#e05e2b] focus:ring-2 focus:ring-[#e05e2b]/20 outline-none transition-all appearance-none cursor-pointer"
        >
          <option value="">كافة درجات الأولوية</option>
      ...
      <div class="relative flex items-center">
        <select
          ...
          class="w-full h-[42px] px-3.5 bg-[#181d28] text-white text-xs font-bold rounded-xl border border-[#374158] hover:border-gray-400 focus:border-[#e05e2b] focus:ring-2 focus:ring-[#e05e2b]/20 outline-none transition-all appearance-none cursor-pointer"
        >
          <option value="">كافة الأقسام الإدارية</option>
...
const departmentFilter = defineModel('departmentFilter', { type: [String, Number], default: '' })
